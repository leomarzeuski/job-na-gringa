            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">
                        Como funciona o <span className="text-blue-400">Método</span>
                    </h2>
                ...
                <div className="relative max-w-4xl mx-auto">
                    {/* Vertical Line */}
                    <div className="absolute left-[15px] md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500/0 via-blue-500/50 to-blue-500/0" />
                    ...
                    <div className="space-y-12">
                        {steps.map((step, index) => (
                            ...
                            >
                                {/* Timeline Dot */}
                                <div className="absolute left-0 md:left-1/2 -translate-x-[5px] md:-translate-x-1/2 w-8 h-8 rounded-full bg-black border-2 border-blue-500 flex items-center justify-center z-10 shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                                    <div className="w-3 h-3 rounded-full bg-blue-400 animate-pulse" />
                                </div>

                                {/* Content */}
                                <div className="ml-12 md:ml-0 md:w-1/2 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors">
